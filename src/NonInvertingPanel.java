...
public class NonInvertingPanel extends JPanel {

    public NonInvertingPanel() {
        ...
        ImageIcon imageIcon = new ImageIcon("images/noninverting_opamp.png"); // Make sure image exists in your project
        ...
        JLabel formulaLabel = new JLabel("<html><center><b>Formula:</b><br>"
                + "V<sub>o</sub> = (1 + Rf/R1) × V<sub>i</sub></center></html>", SwingConstants.CENTER);
